...
const EditarUsuario = () => {
  ...
  const registrarCliente = () => {
    ...
    Axios.put("http://localhost:3001/crm/edit_client/update", {
      txtDocumento: documento,
      txtNombre: nombre,
      txtFechaNac: fechaNac,
      txtFechaCreacion: fechaCreacion,
      txtEmail: email
    });
  };
        ...
        <Grid container>
            <Grid item xs={8}>
              <Box pr={10}>
                ...
                <Box xs={12}>
                  <TextField onChange={(e) => {setNombre(e.target.value)}} fullWidth name="nombre"  variant="outlined"/>
                </Box>
        ...
        <Box py={5}>
          ...
          <Grid container mt={3}>
              ...
              <Grid item xs={3}>
                ...
                <Box xs={12}>
                  <TextField onChange={(e) => {setFechaCreacion(e.target.value)}} fullWidth name="fechaCreacion" placeholder="yyyy/mm/dd" variant="outlined"/>
                </Box>
              </Grid>
